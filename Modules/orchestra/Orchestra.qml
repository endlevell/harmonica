...
PanelWindow {
    ...
    WlrLayershell.keyboardFocus: launcherOpen || recordSettingsOpen || wifiOpen
    ...
    Item {
        ...
        Twitch {
            ...
            WifiManager {
                id: wifiView
                anchors.fill: parent
                opacity: shownView === "wifi" ? enterOp : leavingView === "wifi" ? leaveOp : 0
                y: shownView === "wifi" ? enterY : leavingView === "wifi" ? leaveY : 0
                visible: opacity > 0.001
